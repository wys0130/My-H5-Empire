...
var init_api = __esm({
  "../node_modules/@libsql/core/lib-esm/api.js"() {
    init_functionsRoutes_0_9007093524383651();
...
async function onRequest(context) {
  ...
  try {
    ...
    await db.execute(`
      ...
      VALUES ('admin@coolmall.com', 'admin123456', 'admin')
    `);
    ...
    if (result.rows.length === 0) {
      return new Response(JSON.stringify({ code: 401, message: "\u8D26\u53F7\u6216\u5BC6\u7801\u9519\u8BEF\uFF01" }), {
...
// ../.wrangler/tmp/pages-7DwXqO/functionsRoutes-0.9007093524383651.mjs
var routes;
var init_functionsRoutes_0_9007093524383651 = __esm({
  "../.wrangler/tmp/pages-7DwXqO/functionsRoutes-0.9007093524383651.mjs"() {
    "use strict";
    init_login();
    routes = [
...
// C:/Users/W/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/wrangler/templates/pages-template-worker.ts
init_functionsRoutes_0_9007093524383651();

// C:/Users/W/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/path-to-regexp/dist.es2015/index.js
init_functionsRoutes_0_9007093524383651();
function lexer(str) {
  var tokens = [];
  var i = 0;
